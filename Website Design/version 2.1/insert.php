...
if($_POST["Studentenwerk"] == 0)
{
 ...
 {
 $query = "INSERT INTO F_Survey(countries, age, course, course_lang, daad, daadrate, daadsearch, Universityrate, Uni_add_info, RD_Entry, app_proc, Uni_assist, Uni_assist_app_r, Uni_assist_info, Uni_assist_webinar, Visa_Process_r, Visa_Process_website, Visa_Process_Consulate, Visa_Process_Response, Tuition_Fee, Funding_Opp, Accommodation, Accommodation_info, Accommodation_sugg, Studentenwerk, Studentenwerk_app, Studentenwerk_resp, Studentenwerk_info, Enrollment_process, International_guide, International_resp, International_assis, University_reg, Arrival_assis, IO_Arrival_assis, Language_Pro, German_Course_HC, German_language, Alumni_assis, Finding_Alumni) VALUES (:countries, :age, :course, :course_lang, :daad, :daadrate, :daadsearch, :Universityrate, :Uni_add_info, :RD_Entry, :app_proc, :Uni_assist, :Uni_assist_app_r, :Uni_assist_info, :Uni_assist_webinar, :Visa_Process_r, :Visa_Process_website, :Visa_Process_Consulate, :Visa_Process_Response, :Tuition_Fee, :Funding_Opp, :Accommodation, :Accommodation_info, :Accommodation_sugg, :Studentenwerk, :Studentenwerk_app, :Studentenwerk_resp, :Studentenwerk_info, :Enrollment_process, :International_guide, :International_resp, :International_assis, :University_reg, :Arrival_assis, :IO_Arrival_assis, :Language_Pro, :German_Course_HC, :German_language, :Alumni_assis, :Finding_Alumni)";
